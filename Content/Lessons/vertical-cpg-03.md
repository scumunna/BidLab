...
Onsite, the retailer attributes the sale inside its own walls on a fixed lookback, and you mostly accept logic you cannot fully see. Amazon's offsite DSP delivery still runs the traditional 14-day click and 14-day view lookback, and Walmart Connect Sponsored Search defaults to a 3-day click window with a 14-day option, tuned to the fast CPG purchase cycle. Change the lookback and the same impressions report a different number of sales, which is why the window is a footnote on every report you send.
