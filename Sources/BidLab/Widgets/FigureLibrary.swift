...
enum FigureRegistry {
    ...
    static func view(name: String) -> some View {
        ...
        // Industry deep-dive figures (IndustryFigures.swift)
        case "retailMediaFlow": RetailMediaFlowFigure()
        case "cleanRoomMatch": CleanRoomMatchFigure()
        case "costPerFundedCascade": CostPerFundedCascadeFigure()
        case "lookToBookFunnel": LookToBookFunnelFigure()
        case "seasonalityCurve": SeasonalityCurveFigure()
        case "npiTargeting": NPITargetingFigure()
        case "scriptLift": ScriptLiftFigure()
        case "isiLayout": ISILayoutFigure()
        case "churnLtvCurve": ChurnLtvCurveFigure()
        case "subscriptionLtv": SubscriptionLtvFigure()
        case "dealerTiers": DealerTiersFigure()
        case "tradeVsMedia": TradeVsMediaFigure()
        case "mmmDecomposition": MMMDecompositionFigure()
        case "abmPipeline": ABMPipelineFigure()
        case "geoHoldout", "incrementalityHoldout": GeoHoldoutFigure()
        case "daypartingHeatmap": DaypartingHeatmapFigure()
